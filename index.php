...
<body>
    <div id="interface">
        ...
        <nav id="menu">
            <h1>Menu Principal</h1>
                <ul>
                    <li onmouseover="mudaFoto('_imagens/home.png')" onmouseout="mudaFoto('_imagens/glass-oculos-preto-peq.png')"><a href="index.php">Home</a></li>
        ...
        <article id="noticia-principal">
            <header id="cabecalho-artigo">
                <hgroup>
                    ...
                    <h2>por Éric Ruan</h2>
                    <h3 class="direita">Atualizado em 12/Dezembro/2020</h3>
                </hgroup>
            </header>
    ...
    <aside id="lateral">
        ...
        <video id="filme2" controls="controls" poster="_imagens/video-mini02.jpg">
            <source src="_media/one-day.mp4" type="video/mp4" width="200px">
        </video>
